...
public sealed class SpriteRenderer : Element
{
    ...
    void Element.OnSceneLoad(Scene scene)
    {
    ...
    void Element.OnSceneUpdate() { }

    unsafe void Element.OnSceneRender()
    {
