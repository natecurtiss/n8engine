...
namespace N8Engine.Mathematics
{
    ...
    public struct Vector2
    {
        ...
        /// </summary>
        /// <param name="first"> The Vector2 to subtract from </param>
        /// <param name="second"> The Vector2 to subtract by </param>
        ...
        /// </summary>
        /// <param name="vector2"> Any Vector2 </param>
        /// <param name="multiplier"> The value to multiply by </param>
        /// <returns> The result of the multiplication </returns>
        public static Vector2 operator *(in Vector2 vector2, in float multiplier) => new(vector2.X * multiplier, vector2.Y * multiplier);
        ...
        /// <param name="vector2"> Any Vector2 </param>
        /// <returns> The result of the multiplication </returns>
        public static Vector2 operator *(in float multiplier, in Vector2 vector2) => new(vector2.X * multiplier, vector2.Y * multiplier);
        
        /// <summary>
        /// Multiplies two Vector2s by returning the product of each pair of elements
        /// </summary>
        /// <param name="first"> The first Vector2 </param>
        /// <param name="second"> The second Vector2 </param>
        /// <returns> The product of the Vector2s' pairs of elements; (2, 1) * (3, 2) = (6, 2) </returns>
        public static Vector2 operator *(in Vector2 first, in Vector2 second) => new(first.X * second.X, first.Y * second.Y);
        ...
        public static Vector2 operator /(in Vector2 vector2, in float divisor) => new(vector2.X / divisor, vector2.Y / divisor);
        
        /// <summary>
        /// Divides two Vector2s by returning the quotient of each pair of elements
        /// </summary>
        /// <param name="first"> The first Vector2 </param>
        /// <param name="second"> The second Vector2 </param>
        /// <returns> The quotient of the Vector2s' pairs of elements; (6, 8) / (3, 2) = (2, 4) </returns>
        public static Vector2 operator /(in Vector2 first, in Vector2 second) => new(first.X / second.X, first.Y / second.Y);
        ...
        /// <summary> A vector of (0, 0) </summary>
        public static Vector2 Zero => new();
        
        /// <summary> A vector of (1, 1) </summary>
        public static Vector2 One => new(1f);
        
        /// <summary> A vector of (0, 1) </summary>
        public static Vector2 Up => new(0f, 1f);
        
        /// <summary> A vector of (, -1) </summary>
        public static Vector2 Down => new(0f, -1f);
        
        /// <summary> A vector of (1, 0) </summary>
